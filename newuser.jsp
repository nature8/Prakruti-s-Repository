    ...
    <H1 style="font-family:arial;font-size:50px; text-align:center; color:black">DIGITAL TRAINER ROBOTS </h1>
            ...
            <table width="100%" border="0"class="header">
                <tr align="center">
                    ...
                    <td class="optionstheme"><a href="home.jsp">ABOUT</a></td>
                    <td class="optionstheme"><a href="home.jsp">SETTINGS</a></td>
            ...
            <table style="background-color:rgba(0,120,256,0.3);color:black ;border-radius:20px;" align="center">
                <tr>
                    ...
                    <td><form action="signupDatabase.jsp">
...
<tr>
    ...
    <td>DOB</td>
       <td> <input type="date" name="DOB" class="texttheme"></td>
                     ...
                     <tr>
    <td>Address</td>
           <td><input type="text" name="Address" class="texttheme"></td>
           </tr>
           <td>City</td>
           <td><input type="text" name="City" class="texttheme"></td>
           </tr>
           <tr >
        <td colspan="2"><input type="submit" value="signup" class="btntheme">
            </td>
            </tr>
</form>     </td>
                </tr>
