...
<td>       
    <H1 style="font-family:arial;font-size:50px; text-align:center; color:black">DIGITAL TRAINER ROBOTS </h1>
            ...
            <table width="40%" border="0"class="header" align="center">
                <tr align="center">
                    <tr align="center">
                    <td class="category"><a href="programming.jsp">PROGRAMMING/DEVELOPMENT</a></td> 
                    </tr>
                    
                    <tr align="center">
                        <td class="category"><a href="medical.jsp">MEDICAL FIELD</a></td>
                    </tr>
                   
                    <tr align="center">
                        <td class="category"><a href="Cs.jsp">ENGINEERING WITH COMPUTER SCIENCE</a></td>
                    </tr>
