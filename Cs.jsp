...
<td>       
    <H1 style="font-family:arial;font-size:50px; text-align:center; color:black">DIGITAL TRAINER ROBOTS </h1>
            ...
            <table width="40%" border="0"class="header" align="center">
                <tr align="center">
                    <tr align="center">
                    <td class="category"><a href="maths.jsp">MATHEMATICS</a></td> 
                    </tr>
                    
                    <tr align="center">
                        <td class="category"><a href="programming.jsp">PROGRAMMING LANGUAGE</a></td>
                    </tr>
                   
                    <tr align="center">
                        <td class="category"><a href="dbms.jsp">DBMS</a></td>
                    </tr>
                    <tr align="center">
                        <td class="category"><a href="os.jsp">OPERATING SYSTEM</a></td>
                    </tr>
                    <tr align="center">
                        <td class="category"><a href="dsa.jsp">DATA STRUCTURES AND ALGORITHM</a></td>
                    </tr>
                    <tr align="center">
                        <td class="category"><a href="ed.jsp">ENGINEERING DRAWING / ED</a></td>
                    </tr>
