...
<td>       
    <H1 style="font-family:arial;font-size:50px; text-align:center; color:black">DIGITAL TRAINER ROBOTS </h1>
            ...
            <table width="40%" border="0"class="header" align="center">
                <tr align="center">
                    <tr align="center">
                    <td class="category"><a href="counseling.jsp">COUNSELING</a></td> 
                    </tr>
                    
                    <tr align="center">
                        <td class="category"><a href="clinical.jsp">CLINICAL</a></td>
                    </tr>
                   
                    <tr align="center">
                        <td class="category"><a href="brainstrom.jsp">BRAINSTROMING</a></td>
                    </tr>
                </tr>   
            </table></td>
                </tr>
